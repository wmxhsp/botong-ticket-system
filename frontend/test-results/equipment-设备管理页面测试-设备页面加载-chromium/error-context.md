...
- Name: equipment.spec.ts >> 设备管理页面测试 >> 设备页面加载
- Location: e2e/equipment.spec.ts:4:3
...
```ts
  ...
  2  | 
  3  | test.describe('设备管理页面测试', () => {
  4  |   test('设备页面加载', async ({ page }) => {
  5  |     // 先登录
...
> 7  |     await page.fill('input[type="text"]', 'admin')
  ...
  12 |     
  13 |     // 访问设备页面
  14 |     await page.goto('/equipment')
  15 |     await expect(page).toHaveURL(/\/equipment/)
  16 |     
  17 |     // 验证页面加载
  18 |     await expect(page.locator('.page-equipment, .equipment-page')).toBeVisible({ timeout: 5000 })
  19 |   })
  20 | })
  21 | 
```